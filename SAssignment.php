...
<head>
    ...
    <link rel="stylesheet" href="../CollegeManagementSystem/SAssignment.css">
        ...
        <div class="container2">
           ...
           <?php
            ...
            if(isset($_POST['upload']))
            {
                ...
                $sql = "insert into sassignment(course,semyear,subject,file) values('$Course','$Semester','$Subject','$File')";
                
                if(mysqli_query($con,$sql)){
                    echo "<script>alert('Assignment Uploded Successfully')</script>";
                    $query = mysqli_query($con,"select * from sassignment");
